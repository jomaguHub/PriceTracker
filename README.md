...
This is an Android application **with Jetpack Compose, MVVM, Clean Architecture, Dagger Hilt, SOLID, OkHttp, and WebSockets consumption** that displays live price updates for 25 stock symbols using a WebSocket server.
